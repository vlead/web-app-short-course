...
args = {"__tablename__": "users",
        ...
        "email_id": db.Column(db.Integer, db.ForeignKey('emails.id'), unique=True, nullable=False),
...
class TestPersistenceUser(TestCase):
    ...
    def test_create_user(self):
        ...
        filtered_usr = User.apply_filters(email=Email(email="jimi@gnu.org"),
                                          name=Name(name="Jimi Hendrix"))[0]
        self.assertEqual(filtered_usr.get("email").get("email"), "jimi@gnu.org")
    ...
    def test_query_user(self):
        ...
        n_usr = User.apply_filters(email=em1, name=na1)
        self.assertEqual(n_usr[0].get("name").get("name"), "Jimi Hendrix")
