...
class TestAddUser(TestCase):
    ...
    def test_add_user_passes(self):
        ...
        new_user_to_add = User(name=Name(name="me mine myself"),
    ...
    def test_add_user_with_existing_name_passes(self):
        ...
        user=User(name=Name(name="new user"),
                    email=Email(email="new_admin@gmail.com"),
                    roles=[user_role])
        ...
        new_user_to_add = User(name=Name(name="new user"),
                                  email=Email(email="abc@gnu.org"),
                                  roles=[user_role])
...
class TestShowUserDetails(TestCase):
    ...
    def test_show_user_details_for_user_with_admin_role(self):
        ...
        self.assertEquals(user_returned.get("roles")[0].name, "user")
...
class TestSetName(TestCase):
    ...
    def test_set_name_raises_state_error_non_existing_user(self):
        ...
        new_user = User(name=Name(name="new user"),
...
class TestSetEmail(TestCase):
    ...
    def test_set_email_passes_by_admin(self):
        ...
        new_email = Email(email="xyz@gnu.org")
    ...
    def test_set_email_raises_state_error_non_existing_user(self):
        ...
        new_user = User(name=Name(name="me mine myself"),
                                  email=new_email,
                                  roles=[user_role])
...
class TestDelUser(TestCase):
    ...
    def test_del_user_raises_auth_error(self):
        ...
        another_user = User(name=Name(name="me mine myself"),
                                  email=Email(email="xyz@gnu.org"),
                                  roles=[user_role])
...
class TestGetRolesOfUser(TestCase):
    ...
    def test_get_roles_of_user_with_admin_role(self):
        ...
        self.assertEquals(roles[0].name, "user")
...
class TestDelRoleOfUser(TestCase):
    ...
    def test_del_role_of_user_passes(self):
        ...
        self.assertEquals(ret_user.get("roles")[0].get("name"),
                              Config.user_role)
