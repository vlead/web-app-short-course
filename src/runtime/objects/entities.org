...
class TestRole(TestCase):
    ...
    def test_equality_on_role(self):
        ...
        self.assertEqual(Role(name="user") == Role(name="user"), True)
        self.assertEqual(Role(name="admin") == Role(name="user"), False)
...
class TestUser(TestCase):
    ...
    def test_equality_on_user(self):
        ...
        user2 = User(name=Name(name="DiDley Bo"),
                    email=Email(email="didley@gnu.org"),
                    role=Role(name="admin"))
...
#+BEGIN_SRC python
    ...
    def test_equality_on_session(self):
        ...
        user2 = User(name=Name(name="Bo Didley"),
                    email=Email(email="didley@gnu.org"),
                    role=Role(name="user"))

        session1 = Session(user=user1)
        session2 = Session(user=user2)
        self.assertEqual(session1 == session1, True)
        self.assertEqual(session1 == session2, False)
