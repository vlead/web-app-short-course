    ...
    def mk_set_state(cls):
        def fn(obj):
            ...
            for key in cls.sorted_state_vars:
                ...
                obj.state[key] = value
                if hasattr(value.__class__, 'set_state'):
                    value.__class__.set_state(value)
