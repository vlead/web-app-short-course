...
:END: 
  Requirement satisfied: [[file:~/vlead-projects/bitbucket/web-app-short-course/src/requirements/index.org::#req_user][User]]
...
:END: 
  Requirement satisfied: [[file:~/vlead-projects/bitbucket/web-app-short-course/src/requirements/index.org::#req_user_identification%20][Email]]
#+BEGIN_SRC spec :tangle spec.txt
TYPE Email
#+END_SRC
...
:END: 
  Requirement satisfied: [[file:~/vlead-projects/bitbucket/web-app-short-course/src/requirements/index.org::#req_user_name][Name]]
#+BEGIN_SRC spec :tangle spec.txt
TYPE Name
#+END_SRC
...
:END: 
  Requirement satisfied: [[file:~/vlead-projects/bitbucket/web-app-short-course/src/requirements/index.org::#req_role][Role]]
#+BEGIN_SRC spec :tangle spec.txt
...
:END: 
  Requirement satisfied: [[file:~/vlead-projects/bitbucket/web-app-short-course/src/requirements/index.org::#req_session][Session]]
#+BEGIN_SRC spec :tangle spec.txt
TYPE Session
#+END_SRC
...
* Relations and cardinality constraints over entity types 
  ...
  Requirements satisfied: [[file:~/vlead-projects/bitbucket/web-app-short-course/src/requirements/index.org::#req_user][User]], [[file:~/vlead-projects/bitbucket/web-app-short-course/src/requirements/index.org::#req_user_uniqueness][Email]]
#+BEGIN_SRC spec :tangle spec.txt
;;; Relations with cardinality constraints
[email, user]  :  User?    > Email!
#+END_SRC
  Requirements satisfied: [[file:~/vlead-projects/bitbucket/web-app-short-course/src/requirements/index.org::#req_user][User]], [[file:~/vlead-projects/bitbucket/web-app-short-course/src/requirements/index.org::#req_user_name][Name]]
#+BEGIN_SRC spec :tangle spec.txt
[name, user]   :  User     > Name!
#+END_SRC
  Requirements satisfied: [[file:~/vlead-projects/bitbucket/web-app-short-course/src/requirements/index.org::#req_user][User]], [[file:~/vlead-projects/bitbucket/web-app-short-course/src/requirements/index.org::#req_role][Role]]
#+BEGIN_SRC spec :tangle spec.txt
[role, user]   :  User     > Role!
#+END_SRC
  Requirements satisfied: [[file:~/vlead-projects/bitbucket/web-app-short-course/src/requirements/index.org::#req_user][User]], [[file:~/vlead-projects/bitbucket/web-app-short-course/src/requirements/index.org::#req_session][Session]]
#+BEGIN_SRC spec :tangle spec.txt
...
|--------------------------------------+------------------------+----------------+-------------------|
| setName(u:User, n:Name, s:)          | s.user.role =admin OR  | u:user-set     |                   |
|                                      | s.user = u             | s:session-set  |                   |
|--------------------------------------+------------------------+----------------+-------------------|
